...
curl http://localhost:8983/solr/resource/silkconfig.silkconfig/stopwords_en.xml --data-binary @lang/stopwords_en.xml -H 'Content-type:text/xml; charset=utf-8'
curl http://localhost:8983/solr/resource/silkconfig.silkconfig/protowords.xml  --data-binary @protowords.xml -H 'Content-type:text/xml; charset=utf-8'
curl http://localhost:8983/solr/resource/silkconfig.silkconfig/synonyms.xml  --data-binary @synonyms.xml -H 'Content-type:text/xml; charset=utf-8'
curl http://localhost:8983/solr/resource/silkconfig.silkconfig/stopwords.xml --data-binary @stopwords.xml -H 'Content-type:text/xml; charset=utf-8'
