...
curl http://localhost:8983/solr/resource/silkconfig.silkconfig/stopwords_en.txt --data-binary @lang/stopwords_en.txt -H 'Content-type:text/xml; charset=utf-8'
curl http://localhost:8983/solr/resource/silkconfig.silkconfig/protowords.txt  --data-binary @protowords.txt -H 'Content-type:text/xml; charset=utf-8'
